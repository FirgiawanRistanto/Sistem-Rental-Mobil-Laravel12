...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p><strong>Tanggal Sewa:</strong> {{ $penyewaan->tanggal_sewa->translatedFormat('d F Y H:i') }}</p>
        <p><strong>Tanggal Kembali:</strong> {{ $penyewaan->tanggal_kembali->translatedFormat('d F Y H:i') }}</p>
        <p><strong>Tanggal Kembali Aktual:</strong> {{ $penyewaan->tanggal_kembali_aktual ? $penyewaan->tanggal_kembali_aktual->translatedFormat('d F Y H:i') : '-' }}</p>

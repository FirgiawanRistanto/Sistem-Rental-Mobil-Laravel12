    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.mobils.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="merk" name="merk" required oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '').replace(/\b\w/g, l => l.toUpperCase())" value="<?php echo e(old('merk')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tipe" name="tipe" required oninput="this.value = this.value.replace(/\b\w/g, l => l.toUpperCase())" value="<?php echo e(old('tipe')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nopol" name="nopol" required oninput="this.value = this.value.toUpperCase()" maxlength="11" value="<?php echo e(old('nopol')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="harga_sewa" name="harga_sewa" value="<?php echo e(old('harga_sewa', '0')); ?>" required pattern="[0-9]*" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="denda_per_hari" name="denda_per_hari" value="<?php echo e(old('denda_per_hari', '0')); ?>" required pattern="[0-9]*" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control flatpickr" id="jadwal_perawatan_berikutnya" name="jadwal_perawatan_berikutnya" value="<?php echo e(old('jadwal_perawatan_berikutnya')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="periode_perawatan_hari" name="periode_perawatan_hari" min="0" value="<?php echo e(old('periode_perawatan_hari')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="exterior_labels" name="exterior_labels"><?php echo e(old('exterior_labels')); ?></textarea>
            </div>

            <div class="mb-3">
                <label for="exterior_urutan" class="form-label">Urutan Gambar Eksterior (pisahkan dengan koma):</label>
                <textarea class="form-control" id="exterior_urutan" name="exterior_urutan"><?php echo e(old('exterior_urutan')); ?></textarea>
            </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="interior_labels" name="interior_labels"><?php echo e(old('interior_labels')); ?></textarea>
            </div>

            <div class="mb-3">
                <label for="interior_urutan" class="form-label">Urutan Gambar Interior (pisahkan dengan koma):</label>
                <textarea class="form-control" id="interior_urutan" name="interior_urutan"><?php echo e(old('interior_urutan')); ?></textarea>
            </div>
